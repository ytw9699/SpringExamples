...
<script language="JavaScript">
	...
	function sendAddress2(zipcode,area1,area2,area3,area4){
		var address = area1+" "+area2+" "+area3+" "+area4;
			opener.document.custmodify.zipcode.value=zipcode;
			opener.document.custmodify.address1.value=address;
			opener.document.custmodify.address2.value="";
			opener.document.custmodify.address2.focus();
		    self.close();
	}
</script>
</head>
