	...
	<div class="basket_main">
		<div class="orderInfo">
			...
			<ul>					
					...
					<li class="number">
					<strong>주문번호</strong>&nbsp;&nbsp;&nbsp; <span>${list.order_trade_num}</span>
					</li>
					<li class="date">
					<strong>주문일자</strong>&nbsp;&nbsp;&nbsp;<span><fmt:formatDate value="${list.order_trade_date}" pattern="YY.MM.dd HH:mm" /></span>
					</li>
					<li class="date">
					<strong>입금계좌번호</strong>&nbsp;&nbsp;&nbsp;<span>${list.order_trade_payer}</span>
					</li>
					</c:if>
					</c:forEach>				
			</ul>
	    ...
	    <div style="margin-top:15px; text-align:center;">
			...
			<a href="${contextPath}/pet/order/orderList.dog"><input type="button" value="구매내역"></a>	
			</span>	
		</div>
	</div>
</div>
