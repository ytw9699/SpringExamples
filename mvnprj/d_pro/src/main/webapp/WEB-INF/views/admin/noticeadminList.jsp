			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/pet/admin/adminnoticeList.dog?searchNum=0&isSearch="><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
							...
							<table
								...
								<c:forEach var="noticeList"  items="${noticeList}" varStatus="stat">															
									<tr class="gradeA even" role="row">
										...
										<td style="text-align:center;vertical-align:middle;">${noticeList.subject}</td>
										...
										<c:url var="viewURL2" value="adminnoticeDelete.dog" >
