...
window.onload = function(){
	$("dataTables-example").find('img').each(function(){
		$(this).attr('src');
		});	
}
function delchk(){
...
<div class="row" style="padding-left:15px;width:900px;">    
	<h1 class="page-header">마이펫</h1>
</div>
<div class="row">
	<div class="panel panel-default">
		<div class="panel-heading">
                         마이펫  검색, 수정, 삭제 기능하는 페이지입니다.
        </div>
			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/pet/admin/adminpet_imgList.dog?searchNum=0&isSearch="><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
							...
							<table
								...
								<c:forEach var="list"  items="${list}" varStatus="stat">															
									<tr class="gradeA even" role="row">
										...
										<c:url var="viewURL2" value="adminpet_imgDelete.dog" >
