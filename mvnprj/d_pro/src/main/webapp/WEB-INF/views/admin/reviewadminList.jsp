			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/pet/admin/adminreviewList.dog?searchNum=0&isSearch="><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
							...
							<table
								...
								<c:forEach var="reviewList"  items="${reviewList}" varStatus="stat">															
									<tr class="gradeA even" role="row">
										...
										<c:url var="viewURL2" value="adminreviewDelete.dog" >
