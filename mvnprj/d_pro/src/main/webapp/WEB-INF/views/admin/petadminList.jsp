...
<div class="row" style="padding-left:15px;width:900px;">    
	<h1 class="page-header">분양</h1>
</div>
<div class="row">
	<div class="panel panel-default">
		<div class="panel-heading">
                         분양  검색, 수정, 삭제 기능하는 페이지입니다.
        </div>
			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/pet/admin/adminpetList.dog?searchNum=0&isSearch="><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
							...
							<table
								...
								<thead>
									<tr role="row">
										...
										<th style="width: 9%; text-align:center;">등록일자</th>
								...
								<c:forEach var="list"  items="${list}" varStatus="stat">															
									<tr class="gradeA even" role="row">
										...
										<td style="text-align:center;vertical-align:middle;"><img src="/pet/resources/pet_img_upload/${list.imagefile_savname}" width="60" height="60" alt="" onerror="this.src='/pet/resources/images/noimg_130.gif'" /></td>
										...
										<c:url var="viewURL2" value="adminpetDelete.dog" >
