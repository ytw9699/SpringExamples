			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/pet/admin/adminQnAList.dog?searchNum=0&isSearch="><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
							...
							<table
								...
								<thead>
									<tr role="row">
										...
										<th style="width: 12%; text-align:center;">비밀글 여부</th>
										<th style="width: 40%; text-align:center;">제목 [ 댓글갯수 ]</th>
										<th style="width: 9%; text-align:center;">Admin 답변여부</th>
								...
								<c:forEach var="list"  items="${list}" varStatus="stat">															
									<tr class="gradeA even" role="row">
										...
										<c:url var="viewURL2" value="adminQnADelete.dog" >
