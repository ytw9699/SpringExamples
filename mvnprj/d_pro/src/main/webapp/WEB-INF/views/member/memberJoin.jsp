...
<form:form commandName="member" action="memberEnd.dog" method="post" name="joinform" >
...
<div class="boardWrite ">
        <h3>기본정보</h3><p class="required">회원가입을 위한 필수입력 항목을 입력해 주십시오.</p><div class="boardWrite ">
...
<th scope="row">아이디</th>
                <td>
                <form:input type="text" class="txt w200" path="id" onclick="this.value=''" />	
...
<th scope="row">비밀번호 확인</th>
                <td>
                <form:input type="password" class="txt w200" path="password2" onclick="this.value=''"/>
...
<th scope="row" id="nameTitle">이름</th>
                <td>
                    <form:input type="text" class="txt w200" path="name" onclick="this.value=''"/>
...
<th scope="row">주소</th>
                <td>
                    <form:input type="text" class="txt w200" path="zipcode" onclick="this.value=''" id="zipcode" readonly="true" />                <a href="#none" title="우편번호(새창으로 열기)" onclick="return openZipcode()" id="postBtn"><img src="http://img.echosting.cafe24.com/design/skin/default/member/btn_zip.gif" alt="우편번호"></a><br>
                    <form:input type="text" class="inputTypeText" path="addr" onclick="this.value=''" id="addr1" readonly="true" />
                   	 <form:input type="text" class="inputTypeText" path="addr2" onclick="this.value=''" id="addr2" />
                </td>
            </tr>

<tr>
<th scope="row">휴대전화</th>
                <td><form:input type="text" class="txt w200" path="phone" maxlength="11" onclick="this.value=''"/>
...
<th scope="row">이메일</th>
                <td>
					<form:input type="text" class="txt w200" path="email" onclick="this.value=''" id="email1" />
...
<div class="agreeArea">
        <div class="agree">
            <p>제1조(목적)<br>
  이 약관은&nbsp;펫클럽 회사(전자상거래 사업자)가 운영하는&nbsp;D-편한세상 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.</p>
<p>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」</p>
<p>제2조(정의)<br>
  ①“몰” 이란 펫클럽 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</p>
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.        </div>
        <p><span>이용약관에 동의하십니까?</span> <input id="agree_service_check0" name="mycheck" fw-filter="/1/" fw-label="이용약관 동의" fw-msg="이용약관에 동의 하세요" value="1" type="checkbox"><label for="agree_service_check0">동의함</label></p>
    </div>
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.
        ...
        <p><span>개인정보 수집 및 이용에 동의하십니까?</span> <input id="agree_privacy_check0" name="mycheck" fw-filter="/1/" fw-label="개인정보 수집 및 이용 방침" fw-msg="개인정보 수집 및 이용 방침에 동의하세요" value="1" type="checkbox"><label for="agree_privacy_check0">동의함</label></p>
    </div>
<div class="btnArea">		
