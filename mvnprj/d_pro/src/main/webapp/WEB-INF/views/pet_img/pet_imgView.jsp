...
<script type="text/javascript">
	var onModify = function(no){
		var form = $('.viewForm')[0];
		form.action = 'pet_imgUpdate.dog?no='+no;
		form.submit();
	};
	...
	var onDelete = function(no){
		...
		location.href='pet_imgDelete.dog?no='+num;
	}else {
		return; }
	}
	...
	<c:forEach var="commentlist" items="${commentlist }" varStatus="stat">
			...
			<div class="reply_view">
				<div class="reply_tit">
					...
					<a href="commentDelete.dog?comment_num=${commentlist.comment_num}&pet_img_no=${item.no}" class="btn btnC_01 btnP_02">
